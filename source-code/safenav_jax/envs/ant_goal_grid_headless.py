"""Headless ant grid-world goal environment."""
...
class AntGoalGridHeadless(AntGoalGridBase):
    """Headless ant goal-grid env built with scaling-maze-style XML."""
    ...
    def __init__(
        ...
        hazard_height: float = 1.0,
        backend: str = "mjx",
        n_frames: int | None = 10,
        episode_length: int = 1000,
        reset_noise_scale: float = 0.1,
        healthy_z_range: tuple[float, float] = (0.2, 1.0),
        robot_cost_margin: float = 0.10,
