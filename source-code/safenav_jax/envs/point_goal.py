...
class PointGoal(RenderableGoalEnv):
    """A minimal point robot environment with one randomly sampled goal."""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            ...
            robot_q_size=3,
            robot_qd_size=3,
            visual_target_q_idx=3,
            visual_layout_q_idx=6 if parking_mode else 5,
            visual_target_qd_idx=3,
